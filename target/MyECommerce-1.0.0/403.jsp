...
pageEncoding="utf-8"isErrorPage="true"%>< !DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>MyECommerceSite | 403 Error</title>< !-- Imports --><%@include file="components/imports.jsp"%><style>* {
    margin: 0;
    padding: 0;
}
