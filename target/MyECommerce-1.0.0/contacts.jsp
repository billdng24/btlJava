...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>UnetiShop | Contacts</title>
    <!-- Imports -->
            ...
            <a class="card h-100" href="#map" data-scroll>
              <div class="card-body text-center">
                ...
                <div class="fs-sm text-primary">
                  Click to see map<i
                    class="ci-arrow-right align-middle ms-1"
                  ></i>
                </div>
              </div>
            </a>
            ...
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <ul class="list-unstyled fs-sm mb-0">
                  <li>
                    <span class="text-muted me-1">For customers:</span
                    ><a class="nav-link-style" href="mailto:+108044357260"
                      >customer@example.com</a
                    >
                  </li>
                  <li class="mb-0">
                    <span class="text-muted me-1">Tech support:</span
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex pb-3 border-bottom">
                    ...
                    <div class="ps-3">
                      ...
                      ><a class="d-block text-heading fs-sm" href="#"
                        >514 S. Magnolia St. Orlando, FL 32806, USA</a
                      >
                    </div>
                  </li>
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex pb-3 border-bottom">
                    ...
                    <div class="ps-3">
                      <span class="fs-ms text-muted">Find us</span
                      ><a class="d-block text-heading fs-sm" href="#"
                        >769, Industrial, West Chicago, IL 60185, USA</a
                      >
                    </div>
                  </li>
                  <li class="d-flex pt-2 pb-3 border-bottom">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex pb-3 border-bottom">
                    ...
                    <div class="ps-3">
                      <span class="fs-ms text-muted">Find us</span
                      ><a class="d-block text-heading fs-sm" href="#"
                        >396 Lillian Blvd, Holbrook, NY 11741, USA</a
                      >
                    </div>
                  </li>
                  <li class="d-flex pt-2 pb-3 border-bottom">
        ...
        <div class="row g-0">
          <div class="col-lg-6 iframe-full-height-wrap">
            <iframe
              ...
              width="600"
              height="250"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58202.46479247371!2d72.15060281343418!3d24.25387570225419!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395cbcfdb6d1fd5b%3A0x667f643c949708e3!2sDeesa%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1681631541514!5m2!1sen!2sin"
            ></iframe>
          </div>
