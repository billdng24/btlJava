...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>UnetiShop | Signle ticket</title>
    ...
    <script>
      (function (w, d, s, l, i) {
        ...
        var f = d.getElementsByTagName(s)[0],
          ...
          dl = l != "dataLayer" ? "&l=" + l : "";
        j.async = true;
        j.src = "../www.googletagmanager.com/gtm5445.jsp?id=" + i + dl;
  ...
  <body>
    ...
    <noscript>
      <iframe
        src="http://www.googletagmanager.com/ns.jsp?id=GTM-WKV3GT5"
        height="0"
        width="0"
            ...
            <div class="d-flex align-items-start pb-4 border-bottom">
              ...
              <div class="ps-3">
                ...
                <span class="fs-ms text-muted"
                  ><i class="ci-time align-middle me-2"></i>Sep 30, 2019 at
                  11:05AM</span
                >
              </div>
            </div>
            ...
            <div class="d-flex align-items-start py-4 border-bottom">
              ...
              <div class="ps-3">
                ...
                <p class="fs-md mb-1">
                  ...
                  in massa tempor nec feugiat. Interdum varius sit amet mattis.
                  Magna ac placerat vestibulum lectus mauris. Magna fringilla
                  urna porttitor rhoncus dolor purus non. Urna et pharetra
                  pharetra massa massa ultricies mi quis.
                </p>
                <span class="fs-ms text-muted"
                  ><i class="ci-time align-middle me-2"></i>Sep 28, 2019 at
                  10:00AM</span
                >
                <!-- Comment-->
                <div class="d-flex align-items-start border-top pt-4 mt-4">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="fs-ms text-muted"
                      ><i class="ci-time align-middle me-2"></i>Sep 27, 2019 at
                      6:30PM</span
                    >
                  </div>
                </div>
