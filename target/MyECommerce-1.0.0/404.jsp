...
<head>
<meta charset="utf-8">
<title>UnetiShop | 404 Error</title>
<!-- Imports -->
		...
		<div class="container py-5 mb-lg-3">
			<div class="row justify-content-center pt-lg-4 text-center">
				<div class="col-lg-5 col-md-7 col-sm-9">
					...
					<h3 class="h5 fw-normal mb-4">Có vẻ như chúng tôi không thể tìm thấy trang bạn đang tìm kiếm.
					</h3>
					<div class="fs-md mb-4">
						<p class="text-decoration-underline">Dưới đây là một số liên kết hữu ích thay thế:
						</p>
					</div>
				</div>
			</div>
								...
								<div class="card-body">
									<div class="d-flex align-items-center">
										...
										<div class="ps-3">
											...
											<span class="text-muted fs-ms">Trở về trang chủ</span>
										</div>
									</div>
								</div>
							</a>
...
<%--											<span class="text-muted fs-ms">Tìm kiếm bằng chức năng tìm kiếm nâng cao</span>--%>
<%--										</div>--%>
<%--									</div>--%>
<%--								</div>--%>
<%--							</a>--%>
							...
							<a class="card h-100 border-0 shadow-sm" href="help-topics.jsp">
								<div class="card-body">
									<div class="d-flex align-items-center">
										...
										<div class="ps-3">
											<h5 class="fs-sm mb-0">Trợ giúp & Hỗ trợ</h5>
											<span class="text-muted fs-ms">Truy cập trung tâm trợ giúp của chúng tôi</span>
										</div>
									</div>
								</div>
							</a>
