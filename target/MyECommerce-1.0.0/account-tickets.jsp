...
pageEncoding="utf-8"%> <% Connection cn = ConnectionProvider.getCon();
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>UnetiShop | Support tickets</title>
  ...
  <body>
    <main class="page-wrapper">
      <!-- Open Ticket Modal-->
      <form
        class="needs-validation modal fade"
        method="post"
        id="open-ticket"
        tabindex="-1"
        novalidate
            ...
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              >
                <div class="d-md-flex align-items-center">
                  ...
                  >
                    <span
                      class="badge bg-success position-absolute end-0 mt-n2"
                  ...
                  <div class="ps-md-3">
                    <h3 class="fs-base mb-0">
                      <%=rsH.getString("user_name")%>
                    </h3>
                    <span class="text-accent fs-sm"
                      ><%=rsH.getString("user_email")%></span
                    >
                  </div>
                </div>
                <a
              ...
              <div class="d-lg-block collapse" id="account-menu">
                ...
                <ul class="list-unstyled mb-0">
                  <% ps = cn.prepareStatement("SELECT count(order_id) FROM
                  shop_order WHERE user_id=?"); ps.setString(1,
                  session.getAttribute("uid").toString()); rs =
                  ps.executeQuery(); rs.next(); %>
                  <li class="border-bottom mb-0">
                    <a
                      class="nav-link-style d-flex align-items-center px-4 py-3"
                      href="account-orders.jsp"
                      ><i class="ci-bag opacity-60 me-2"></i>Orders<span
                  ...
                  <li class="border-bottom mb-0">
                    <a
                      ...
                      ><i class="ci-heart opacity-60 me-2"></i>Wishlist<span
                        class="fs-sm text-muted ms-auto"
                        >3</span
                      ></a
                    >
                  ...
                  <li class="mb-0">
                    <a
                      ...
                      href="account-tickets.jsp"
                      ><i class="ci-help opacity-60 me-2"></i>Support
                      tickets<span class="fs-sm text-muted ms-auto">1</span></a
                    >
                  </li>
                </ul>
                <div class="bg-secondary px-4 py-3">
                ...
                <ul class="list-unstyled mb-0">
                  ...
                  <li class="mb-0">
                    <a
                      class="nav-link-style d-flex align-items-center px-4 py-3"
                      href="account-payment.jsp"
                      ><i class="ci-card opacity-60 me-2"></i>Payment methods</a
                    >
                  </li>
                  <li class="d-lg-none border-top mb-0">
                    <a
                      class="nav-link-style d-flex align-items-center px-4 py-3"
                      href="account-signin.jsp?SignOut=1"
              ...
              <table class="table table-hover mb-0">
                ...
                <tbody>
                  <tr>
                    <td class="py-3">
                      <a
                        class="nav-link-style fw-medium"
                        href="account-single-ticket.jsp"
                        >My new ticket</a
                      >
                    </td>
                    ...
                    <td class="py-3">
                      <span class="badge bg-warning m-0">High</span>
                    </td>
                    <td class="py-3">
                      <span class="badge bg-success m-0">Open</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="py-3">
                    ...
                    <td class="py-3">
                      <span class="badge bg-info m-0">Medium</span>
                    </td>
                    <td class="py-3">
                      <span class="badge bg-secondary m-0">Closed</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="py-3">
                  ...
                  <tr>
                    ...
                    <td class="py-3">
                      <span class="badge bg-success m-0">Low</span>
                    </td>
                    <td class="py-3">
                      <span class="badge bg-secondary m-0">Closed</span>
                    </td>
