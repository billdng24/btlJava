...
(request.getParameter("SignOut") != null) { session.removeAttribute("aid");
response.sendRedirect("index.jsp"); } else if (session.getAttribute("aid") !=
null) { response.sendRedirect("AdminPanel.jsp"); } %>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
  ...
  <body>
    <main class="page-wrapper">
      ...
      <form
        class="container text-center col-md-4 mt-5 mb-5 form"
        action=""
        method="POST"
        id="frmLogin"
        data-aos="fade-up"
      >
        <h1 class="display-3 mb-3">Admin đăng nhập</h1>
        <% Cookie[] items=request.getCookies(); String adminEmail=""; String
        adminPassword=""; for(Cookie item:items){
        ...
        <div class="mb-4 text-end">
          <a href="ResetPassword.jsp" class="text-decoration-none"
            >Quên Mật khẩu ?</a
          >
        </div>
        <button
