    ...
    <main class="page-wrapper">
            ...
            <nav aria-label="breadcrumb">
              ...
              >
                <li class="breadcrumb-item">
                  <a class="text-nowrap" href="index.jsp"
      ...
      <div class="container pb-5 mb-2 mb-md-4">
        ...
        <div class="featured-posts-carousel tns-carousel pt-5">
          ...
          >
            <article>
              <a class="blog-entry-thumb mb-3" href="blog-post.jsp"
                ><span class="blog-entry-meta-label fs-sm"
                  ><i class="ci-time"></i>Sep 10</span
              ...
              <div class="d-flex justify-content-between mb-2 pt-1">
                ...
                <a
                  ...
                  href="blog-post.jsp#comments"
                  ><i class="ci-message"></i>13</a
                >
              </div>
              <div class="d-flex align-items-center fs-sm">
                ...
                <div class="fs-sm text-muted">
                  in <a href="#" class="blog-entry-meta-link">Lifestyle</a>,
            ...
            <article>
              <a class="blog-entry-thumb mb-3" href="blog-post.jsp"
                ><span class="blog-entry-meta-label fs-sm"
                  ><i class="ci-time"></i>Aug 27</span
                ><img src="img/blog/featured/02.jpg" alt="Featured post"
              /></a>
              <div class="d-flex justify-content-between mb-2 pt-1">
                <h2 class="h5 blog-entry-title mb-0">
                  <a href="blog-post.jsp"
                    >Online Payment Security Tips for Shoppers</a
                  >
                </h2>
                <a
                  class="blog-entry-meta-link fs-sm text-nowrap ms-3 pt-1"
                  href="blog-post.jsp#comments"
                  ><i class="ci-message"></i>9</a
                >
              </div>
              <div class="d-flex align-items-center fs-sm">
                <a class="blog-entry-meta-link" href="#">
                ...
                <div class="fs-sm text-muted">
                  in
                  <a href="#" class="blog-entry-meta-link">Online shpopping</a>
                </div>
              </div>
            </article>
            <article>
              <a class="blog-entry-thumb mb-3" href="blog-post.jsp"
                ><span class="blog-entry-meta-label fs-sm"
                  ><i class="ci-time"></i>Aug 16</span
                ><img src="img/blog/featured/03.jpg" alt="Featured post"
              /></a>
              <div class="d-flex justify-content-between mb-2 pt-1">
                <h2 class="h5 blog-entry-title mb-0">
                  <a href="blog-post.jsp"
                    >We Launched New Store in San Francisco!</a
                  >
                </h2>
                <a
                  class="blog-entry-meta-link fs-sm text-nowrap ms-3 pt-1"
                  href="blog-post.jsp#comments"
                  ><i class="ci-message"></i>23</a
                >
              </div>
              <div class="d-flex align-items-center fs-sm">
                <a class="blog-entry-meta-link" href="#">
        ...
        <div class="row pt-5 mt-md-2">
          ...
          <section class="col-lg-8">
            <div class="masonry-grid" data-columns="2">
                ...
                <div class="card">
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
                        >Global Travel and Vacations on a Tight Budget</a
                      >
                    </h2>
                    <p class="fs-sm">
              ...
              <article class="masonry-grid-item">
                <div class="card">
                  <a class="blog-entry-thumb" href="blog-post.jsp"
                    ><img class="card-img-top" src="img/blog/01.jpg" alt="Post"
                  /></a>
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
                        >Top New Trends in Suburban High Fashion</a
                      >
                    </h2>
                    <p class="fs-sm">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              ...
              <article class="masonry-grid-item">
                <div class="card">
                  <a class="blog-entry-thumb" href="blog-post.jsp"
                    ><img class="card-img-top" src="img/blog/02.jpg" alt="Post"
                  /></a>
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
                        >Shopping Tips. Places Where to Buy Cheap</a
                      >
                    </h2>
                    <p class="fs-sm">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              ...
              <article class="masonry-grid-item">
                <div class="card">
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
                        >Google Pay is Now Available in All Outlets</a
                      >
                    </h2>
                    <p class="fs-sm">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              ...
              <article class="masonry-grid-item">
                <div class="card gallery" data-video="true">
                  <a
                    class="blog-entry-thumb gallery-item video-item"
                    href="https://www.youtube.com/watch?v=mzhvR4wm__M"
                    ><span class="blog-entry-meta-label fs-sm"
                      ><i class="ci-video"></i
                      ><span class="fs-ms">Watch video</span></span
                    ><img class="card-img-top" src="img/blog/03.jpg" alt="Post"
                  /></a>
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
              ...
              <article class="masonry-grid-item">
                <div class="card">
                  <a class="blog-entry-thumb" href="blog-post.jsp"
                    ><img class="card-img-top" src="img/blog/04.jpg" alt="Post"
                  /></a>
                  <div class="card-body">
                    <h2 class="h6 blog-entry-title">
                      <a href="blog-post.jsp"
                        >Payments Made Easy. How New Technology will Affect
                        E-Commerce Industry Worldwide?</a
                      >
                    </h2>
                    <p class="fs-sm">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              ...
              >
                  ...
                  <ul class="widget-list">
                    <li class="widget-list-item">
                      <a
                        ...
                        ><span class="fs-xs text-muted ms-3">18</span></a
                      >
                    </li>
                    <li class="widget-list-item">
                      <a
                        ...
                        href="#"
                        ><span>Fashion</span
                        ><span class="fs-xs text-muted ms-3">25</span></a
                      >
                    </li>
                    <li class="widget-list-item">
                      <a
                        ...
                        ><span class="fs-xs text-muted ms-3">13</span></a
                      >
                    </li>
                    <li class="widget-list-item">
                      <a
                        ...
                        ><span class="fs-xs text-muted ms-3">7</span></a
                      >
                    </li>
                    <li class="widget-list-item">
                      <a
                        ...
                        href="#"
                        ><span>Lifestyle</span
                        ><span class="fs-xs text-muted ms-3">34</span></a
                      >
                    </li>
                    <li class="widget-list-item">
                      <a
                        ...
                        ><span class="fs-xs text-muted ms-3">6</span></a
                      >
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <div class="d-flex align-items-center mb-3">
                    <a class="flex-shrink-0" href="blog-post.jsp"
                      ><img
                        class="rounded"
                    ...
                    <div class="ps-3">
                      <h6 class="blog-entry-title fs-sm mb-0">
                        <a href="blog-post.jsp"
                          >Retro Cameras are Trending. Why so Popular?</a
                        >
                      </h6>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6 class="blog-entry-title fs-sm mb-0">
                        <a href="blog-post.jsp"
                          >Augmented Reality - Game Changing Technology</a
                        >
                      </h6>
                      <span class="fs-ms text-muted"
                        >by
