...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>UnetiShop | Checkout-Tracking</title>
    <!-- Imports -->
  ...
  <body>
    <main class="page-wrapper">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">
                Order No - <%=request.getParameter("order_id")%>
              </h5>
              <button
                class="btn-close"
                type="button"
            ...
            <div class="modal-body pb-0">
              ...
              >
                <div class="d-sm-flex text-center text-sm-start">
                  <a
                    class="d-inline-block flex-shrink-0 mx-auto"
                  ...
                  <div class="ps-sm-4 pt-2">
                    ...
                    <div class="fs-sm">
                      <span class="text-muted me-2">Color:</span>Pink / Beige /
                      Dark blue
                    </div>
            ...
            >
              <div class="px-2 py-1">
                ...
                ><span>$265.<small>00</small></span>
              </div>
              <div class="px-2 py-1">
                <span class="text-muted">Shipping:&nbsp;</span
                ><span>$22.<small>50</small></span>
              </div>
              <div class="px-2 py-1">
                <span class="text-muted">Tax:&nbsp;</span
                ><span>$9.<small>50</small></span>
              </div>
              <div class="px-2 py-1">
                <span class="text-muted">Total:&nbsp;</span
                ><span class="fs-lg">$297.<small>00</small></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
            ...
            <nav aria-label="breadcrumb">
              ...
              >
                ...
                <li class="breadcrumb-item text-nowrap">
                  <a href="shop-categories.jsp">Shop</a>
                </li>
                <li
          ...
          <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 text-light mb-0">
              Tracking order:
              <span class="h4 fw-normal text-light"
                ><%=request.getParameter("order_id")%></span
              >
            </h1>
          </div>
        </div>
      ...
      <% Connection cn = ConnectionProvider.getCon(); PreparedStatement ps =
      cn.prepareStatement( "SELECT OS.status_value FROM shop_order SO INNER JOIN
      order_status OS ON SO.order_status=OS.status_id WHERE order_id=?");
      ps.setString(1, request.getParameter("order_id")); ResultSet rs =
      ps.executeQuery(); rs.next(); String status =
      rs.getString("status_value"); boolean orderPlaced = false; boolean
      processing = false; boolean qualityCheck = false; boolean dispatched =
      false; boolean isCompleted = false; String active = "active"; String
      completed = "completed"; if (status.equalsIgnoreCase("pending")) {
      orderPlaced = true; } if (status.equalsIgnoreCase("Shipped")) {
      orderPlaced = true; processing = true; } if
      (status.equalsIgnoreCase("Manual Verification")) { orderPlaced = true;
      processing = true; qualityCheck = true; } if
      (status.equalsIgnoreCase("Dispatched")) { orderPlaced = true; processing =
      true; qualityCheck = true; dispatched = true; } if
      (status.equalsIgnoreCase("completed")) { orderPlaced = true; processing =
      true; qualityCheck = true; dispatched = true; isCompleted = true; } %>
        ...
        <div class="row gx-4 mb-4" id="orderDetails">
          ...
          <div class="col-md-4 mb-2">
            <div class="bg-secondary h-100 p-4 text-center rounded-3">
              ...
              <span class="fw-medium text-dark me-2">Expected date:</span
              ><%=format.format(date)%>
            </div>
          </div>
        </div>
              ...
              <li class="nav-item">
                ...
                >
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <div class="media-tab-subtitle text-muted fs-xs mb-1">
                        First step
                      </div>
